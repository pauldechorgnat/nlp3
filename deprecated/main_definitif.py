...
if __name__=='__main__':
	...
	if not silent : 
		...
		print(attributes_train[0])
		print(tokenize(attributes_train[0]))

		print(parsing_attributes(attributes_train))
		raise ChocolateError
	...
	if MODE == 'train':
		for index_epoch in range(1, EPOCHS+1):
			list_of_batch_index = generate_batches_index(number_of_samples = VOCABULARY_SIZE, batch_size = 100)
